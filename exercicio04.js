...
let nota = Number.parseInt(prompt("Digite a nota portugues"))
let nota1 = Number.parseInt (prompt("Digite a nota filosofia: "))
let nota2 = Number.parseInt (prompt("Digite a nota matemática: "))
let nota3 = Number.parseInt (prompt("Digite a nota Geografia: "))

let media = (nota + nota1 + nota2 + nota3)
